    ...
    self.loadFromStorage = function() {
        ...
        try {
            ...
            if (self.currentIndex >= 0 && self.currentIndex < self.states.length) {
                ...
                // Fit the restored diagram to the current screen, rather
                // than leaving the viewer wherever the model's raw x/y
                // coordinates land at scale 1 (reads as "too zoomed in").
                self.loopy.fitToScreenOnLoad();
            }
